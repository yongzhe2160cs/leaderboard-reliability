...
![GPQA Diamond tie bands](docs/screenshot.png)

*The top five overlap completely (band #1); o1 stands alone (band #2); the two
2024 models form band #3. Generated by `python docs/make_screenshot.py`; the
Streamlit app renders the same view interactively.*
